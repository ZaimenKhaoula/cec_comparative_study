...
coordinates= Outils.generate_coordinates_archi10()
...
save_results('BA_archi10_correct_brick_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
...
for i in range(0):
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GA_archi10_correct_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    print("executing  PSO")
    model = PSO.OriginalPSO(epoch, pop_size, c1=2.0, c2=2, w_min=0.4, w_max=0.9)
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}")
    save_results('PSO_archi10_correct_brick_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('DE_archi10_correct_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('CSA_archi10_correct_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    print("executing  GWO")
    model = OriginalGWO(epoch, pop_size)
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GWO_archi10_correct_13', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('CSA_archi10_correct_10', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GWO_archi10_correct_10', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
