...
coordinates= Outils.generate_coordinates_archi4()
...
for i in range(nb_runs):
    ...
    save_results('BA_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    ...
    save_results('PSO_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('DE_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('HS_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GA_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('CSA_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GWO_archi4_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
