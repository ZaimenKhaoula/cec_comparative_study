...
for i in range(nb_runs):
    ...
    save_results('CSA_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GWO_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution:{list(best_position)}, Fitness: {best_fitness}")
    save_results('BA_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    save_results('PSO_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('DE_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('HS_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    save_results('GA_archi1_correct', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
