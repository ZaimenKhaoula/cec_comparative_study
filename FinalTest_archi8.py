...
coordinates= Outils.generate_coordinates_archi8()
...
#save_results('DE_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
...
for i in range(0):
    ...
    #save_results('PSO_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    #save_results('HS_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    #save_results('GA_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    # save_results('CSA_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    """
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution: {list(best_position)}, Fitness: {best_fitness}")
    # save_results('GWO_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
    ...
    best_position, best_fitness = model.solve(deployment_problem)
    print(f"Solution:{list(best_position)}, Fitness: {best_fitness}")
    # save_results('BA_archi8_correct_1', str(f"Best solution: {list(best_position)}, Best fitness: {best_fitness}"))
    print(model.history.list_global_best_fit)
